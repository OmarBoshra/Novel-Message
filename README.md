...
using a special library or someform of richtext editor that consumes large amount of
space and makes all text editors similar . This app does just that a simple custumizable textediting method exists that
